...
M.setup = function()
	local signs = {
		{ name = "DiagnosticSignError", text = globals.error_symbol },
		{ name = "DiagnosticSignWarn", text = globals.warning_symbol },
		{ name = "DiagnosticSignHint", text = globals.hint_symbol },
		{ name = "DiagnosticSignInfo", text = globals.info_symbol },
	}
...
local function lsp_keymaps(bufnr)
	...
	vim.api.nvim_buf_set_keymap(bufnr, "n", "gD", '<cmd>lua vim.diagnostic.goto_prev({ border = "rounded" })<CR>', opts)
	vim.api.nvim_buf_set_keymap(bufnr, "n", "gd", '<cmd>lua vim.diagnostic.goto_next({ border = "rounded" })<CR>', opts)
